...
**Exclusion Rules & Preferences:** 
- PRIORITIZE direct employer career pages or primary job boards.
- MINIMIZE results from staffing agencies or third-party recruiters where possible, but include them if the role is a strong match and currently active.
- EXCLUDE expired or old postings. Only return roles posted within the last 30 days that are clearly still active.
...
- Length: Maximum 1000 characters total. Keep it concise (3-4 short paragraphs).
...
- Header Removal: DO NOT include [Your Name], [Address], [Phone], [Email], [Date], or [Hiring Manager/Company Address] blocks. 
- Output ONLY the body of the cover letter text — starting with the salutation (e.g., "Dear Hiring Team,") and ending with the sign-off.
`;
